package vip.yeee.memo.integrate.webservice.service.impl;
...
@WebService(serviceName="UserService",//对外发布的服务名
			...
			endpointInterface= "vip.yeee.memo.integrate.webservice.service.UserService")//服务接口全路径, 指定做SEI（Service EndPoint Interface）服务端点接口
@Component
