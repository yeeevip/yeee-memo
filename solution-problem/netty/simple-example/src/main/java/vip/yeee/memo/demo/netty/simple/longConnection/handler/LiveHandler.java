package vip.yeee.memo.demo.netty.simple.longConnection.handler;

import vip.yeee.memo.demo.netty.simple.longConnection.kit.LiveChannelCache;
...
public class LiveHandler extends SimpleChannelInboundHandler<LiveMessage> {
    ...
    private final Logger logger = LoggerFactory.getLogger(LiveHandler.class);
