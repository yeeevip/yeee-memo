package vip.yeee.memo.integrate.stools.kit.kit.filewatch;
 ...
 *
 * @author yeeee
 * @since 2023/4/21 17:01
 */
public class FileWatchKit2 {

    public void startWatch(String filePath) throws IOException {
        // 这里的监听必须是目录
