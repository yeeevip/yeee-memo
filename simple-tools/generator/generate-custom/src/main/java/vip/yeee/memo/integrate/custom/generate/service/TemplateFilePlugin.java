package vip.yeee.memo.integrate.custom.generate.service;
...
import vip.yeee.memo.integrate.custom.generate.service.file.GenerateByListTemplateFile;
import vip.yeee.memo.integrate.custom.generate.service.file.GenerateByTemplateFile;
import vip.yeee.memo.integrate.custom.generate.service.formatter.ListTemplateFormatter;
...
import vip.yeee.memo.integrate.custom.generate.service.model.TableColumnBuilder;
...
public class TemplateFilePlugin extends PluginAdapter {
     ...
     * 默认的模板格式化类
     */
    public static final String DEFAULT_TEMPLATEFORMATTER = "vip.yeee.memo.integrate.custom.generate.service.formatter.FreemarkerTemplateFormatter";
    /**
     * 单个文件模式
     */
