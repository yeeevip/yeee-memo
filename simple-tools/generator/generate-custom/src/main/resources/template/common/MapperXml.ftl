...
<mapper namespace="${package}.${tableClass.shortClassName}${mapperSuffix}">
    ...
    <select id="getList" resultType="${tableClass.packageName}.${tableClass.shortClassName}">
        SELECT
        <#if tableClass.allFields??>
            <#list tableClass.allFields as field>
    ...
    <select id="getOne" resultType="${tableClass.packageName}.${tableClass.shortClassName}">
        SELECT
        <#if tableClass.allFields??>
            <#list tableClass.allFields as field>
            ${field.columnName}<#if field_has_next>,</#if>
    ...
    <resultMap type="${tableClass.packageName}.${tableClass.shortClassName}" id="XXXXXXXXXXXXXXXDtoMap">
        <#if tableClass.allFields??>
            <#list tableClass.allFields as field>
    ...
    <insert id="insert" parameterType="${tableClass.packageName}.${tableClass.shortClassName}" useGeneratedKeys="true" keyProperty="id">
    ...
    <!-- 删掉if id -->
    <update id="updateByPrimaryKey" parameterType="${tableClass.packageName}.${tableClass.shortClassName}">
