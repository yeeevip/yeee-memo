...
import vip.yeee.memo.common.websocket.netty.annotation.RequestParam;

import java.util.List;
import java.util.Map;

import static vip.yeee.memo.common.websocket.netty.bootstrap.WsEndpointDispatcher.REQUEST_PARAM;
