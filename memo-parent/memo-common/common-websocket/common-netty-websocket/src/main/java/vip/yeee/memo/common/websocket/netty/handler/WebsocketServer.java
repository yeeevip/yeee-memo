...
import vip.yeee.memo.common.websocket.netty.util.SslUtils;
...
public class WebsocketServer {
    ...
    public WebsocketServer(WsEndpointDispatcher webSocketServerHandler, ServerEndpointConfig serverEndpointConfig) {
        this.wsEndpointDispatcher = webSocketServerHandler;
        ...
        bootstrap.group(boss, worker)
                ...
                .childHandler(new ChannelInitializer<NioSocketChannel>() {
                    ...
                    protected void initChannel(NioSocketChannel ch) {
                        ...
                        pipeline.addLast(new HttpServerHandler(wsEndpointDispatcher, config, finalEventExecutorGroup, corsConfig != null));
                    }
                });
    ...
    public WsEndpointDispatcher getWsEndpointDispatcher() {
        return wsEndpointDispatcher;
    }
}
